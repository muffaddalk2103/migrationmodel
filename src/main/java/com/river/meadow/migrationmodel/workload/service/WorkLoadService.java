...
import com.river.meadow.migrationmodel.dao.entity.Credentials;
import com.river.meadow.migrationmodel.dao.entity.Source;
import com.river.meadow.migrationmodel.dao.entity.Volume;
import com.river.meadow.migrationmodel.dao.repository.SourceRepository;
import com.river.meadow.migrationmodel.model.Messages;
import com.river.meadow.migrationmodel.model.Response;
import com.river.meadow.migrationmodel.model.Workload;
import com.river.meadow.migrationmodel.util.CommonUtil;
	...
	public List<Workload> getWorkloads() {
		...
		try{
			...
			for(Source source:result){
				...
				workload.setCredentials(new com.river.meadow.migrationmodel.model.Credentials());
				...
				if(source.getVolumes()!=null){
					...
					source.getVolumes().forEach(s->{com.river.meadow.migrationmodel.model.Volume volume = new com.river.meadow.migrationmodel.model.Volume();volume.setMountPoint(s.getMountPoint());volume.setVolumeSize(s.getVolumeSize());workload.getStorage().add(volume);});	
				}
